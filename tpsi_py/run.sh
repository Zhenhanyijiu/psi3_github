...
PY37_BIN=python3
nohup ${PY37_BIN} psi3_process.py --m=20000000 --i=30000 --p=0 >/dev/null 2>&1 &
nohup ${PY37_BIN} psi3_process.py --m=20000000 --i=30000 --p=1 >/dev/null 2>&1 &
time ${PY37_BIN} psi3_process.py --m=20000000 --i=30000 --p=2